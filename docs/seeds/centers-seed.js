...
(async () => {
  const CENTERS = [
    ...
    { name: '자마이카피트니스 신림점', type: '헬스', loc: '관악',
      addr: '서울 관악구 신림동 1422-5',
      lat: 37.4847655963, lng: 126.9300886308 },
    { name: '짐박스피트니스 사당2호점', type: '헬스', loc: '관악',
      addr: '서울 관악구 남현동 1059-16',
      lat: 37.4761293317, lng: 126.9790624656 },
    { name: '짐박스피트니스 신림본점', type: '헬스', loc: '관악',
      addr: '서울 관악구 신림동 1747',
      lat: 37.4702225365, lng: 126.93842453 },
    { name: '킹짐', type: '헬스', loc: '관악',
      addr: '서울 관악구 신림동 1514-1',
      lat: 37.4710975543, lng: 126.9343274758 },
    ...
    { name: '에이블짐 한양대점', type: '헬스', loc: '성동',
      addr: '서울 성동구 행당동 12',
      lat: 37.5602938277, lng: 127.0414875125 },
