...
Performance: 헬스장에서 회원에게 말 걸듯 가깝고 경쾌하게. 소리 지르지는 않는다.
  ★가슴에서 울리는 힘 있고 자신감 있는 목소리. 얇고 소심하거나 콧소리 섞인 '찐따 같은' 톤 절대 금지(대표 9-07). 말끝을 내리지 말고 단단하게 맺는다.""",
    },
    'grandma': {
        'voice': 'Sulafat',
...
Performance: 놀이터에서 뛰어오며 반갑게 부르는 톤. 비명 지르듯 하지는 않는다.
  ★대사가 길어도 **처음부터 끝까지 6살 아이 목소리 하나로 유지**한다. 문장 중간에 성인 여성 톤으로
  내려가거나 다른 사람처럼 바뀌지 않는다. 한 아이가 한 호흡에 신나서 쭉 말하는 것이다.""",
    },
}
